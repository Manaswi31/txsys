...
n = 1/sqrt(2)*[randn(1,N) + j*randn(1,N)]; % white gaussian noise, 0dB variance. This is a general term, even imaginary part is not used in BPSK.
...
for ii = 1:length(Eb_N0_dB)
   ...
   % counting the errors
   % if d_est isn't identical to the source bit stream, it's an error 
   nErr(ii) = size(find([d_est - d]),2);
